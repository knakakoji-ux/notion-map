...
# --- ④-2 メリクロンが今いる市場：規模・密度・天井 ---
H.append('<div style="border-top:1px dashed #e4e2d9;margin-top:22px;padding-top:18px">')
H.append('<h3 style="font-size:15px;color:#b0563f;margin-bottom:6px">では、メリクロンはいくらの市場に資源を突っ込んでいるのか</h3>')
H.append('<p style="font-size:13px">河野メリクロン（売上 約62億円・2019/9期、その大半が育毛剤「蘭夢」と蘭苗）の主戦場は、'
         '<b>縮む非EC通販1.8兆円のなかの「健康食品・化粧品の単品リピート通販」</b>。'
         'この池は<b>健食通販だけで主要112社が7,035億円</b>を奪い合い（FY2023・日本流通産業新聞）、化粧品通販でも上位90社がひしめく。'
         'しかも上位はサントリーウエルネス・DHC・ファンケルら<b>少数の大手が過半を占める寡占</b>。'
         'メリクロンのシェアは健食通販112社の中で<b>約0.9%</b>、非EC通販1.8兆に対しては<b>約0.3%</b>にすぎない。</p>')
players=[
 ('サントリーウエルネス',1103,'#6b7a8c','国内・通販主体 FY2025'),
 ('ファンケル',1126,'#6b7a8c','全社 FY2025（うち通販571）'),
 ('DHC',987,'#6b7a8c','全社 FY2024（うち健食通販529）'),
 ('オルビス',502,'#7d8a98','D2C・EC中心 FY2025'),
 ('世田谷自然食品',335,'#9a9486','通販専業'),
 ('再春館製薬所',228,'#9a9486','ドモホルンリンクル・通販専業'),
 ('やずや',170,'#9a9486','健食通販'),
 ('プレミアアンチエイジング',161,'#9a9486','D2C（DUO）'),
 ('えがお',150,'#9a9486','健食通販'),
 ('北の達人',112,'#9a9486','EC単品通販'),
 ('河野メリクロン',62,C_NEWS,'全社・育毛剤蘭夢＋蘭苗 2019/9期'),
]
H.append('<div style="font-size:12px;color:#6b6a66;font-weight:700;margin:14px 0 2px">健食・化粧品 単品通販の主要プレイヤー売上（億円）─ 大手1,000億級／メリクロンは約1/18</div>')
H.append(hbars(players,label_w=176,maxv=1126,unit='億円',fmt='{:,.0f}'))
H.append('<div class="note">基準混在（全社／通販部門が混ざる）。順位より「桁」を見る図。'
         '出典：各社IR・官報・業界紙（日本流通産業新聞 健食通販ランキングFY2023ほか）。メリクロンはYahoo!しごとカタログの法人DB値（推計）。</div>')
H.append('<div class="concl" style="margin-top:14px"><h3>old通販を“極めた”ところで、天井はどこか</h3>'
         '<p style="margin:0 0 8px;font-size:13px">'
         '<b>① 器が小さく、縮む。</b>非EC通販1.8兆円は漸減。健食通販112社の合計も実質横ばい（+1.05%）。極限まで磨いても土俵自体が広がらない。</p>'
         '<p style="margin:0 0 8px;font-size:13px">'
         '<b>② 客が高齢で、自然に減る。</b>新聞通販客は60代以上66.7%・70代以上47.6%。リピート資産は厚いが、新規の入口（新聞・高齢層）が毎年細り高齢化する。'
         '“極める”ほど、加齢で抜けていく顧客の補充が追いつかなくなる。</p>'
         '<p style="margin:0;font-size:13px">'
         '<b>③ 上位はすでに old通販を出ている。</b>サントリーW・DHC・ファンケル・オルビスはEC・モール・海外・実店舗へ移行済み（オルビスはEC化率5〜6割）。'
         '<b>“old通販を極める”とは、大手が出ていく部屋を一人で磨くこと</b>に近い。</p></div>')
H.append('<div class="flag"><b>答え：</b>メリクロンは「縮む1.8兆円の非EC通販」、なかでも<b>112社が7,035億円を奪い合い大手が寡占する健食・化粧品の単品通販</b>に資源の大半を投下している。'
         'ここを完璧にしても到達できる上限は<b>「中位の単品通販事業者（売上で大手の数分の一）」</b>であり、その顧客は高齢化で目減りする。'
         '<b>成長はこの部屋の中では作れない</b>——伸びしろはEC（化粧品1.15兆・モール47%）／ギフト（eギフト60倍・若年女性）／実店舗（DgSビューティ1.8兆）という別の部屋にしか存在しない。</div>')
H.append('</div>')
H.append('</div>')
